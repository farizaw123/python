...
hap1 = Button(root,text="<-",padx = 30,bg="#FF5733",fg="white", pady = 20,command=hapusSatu)
tam = Button(root,text="+",padx = 30,bg="#FF5733",fg="white", pady = 20,command=tambah)
kur = Button(root,text="-",padx = 30,bg="#FF5733",fg="white", pady = 20,command=kurang)
bag  = Button(root,text="/",padx = 30,bg="#FF5733",fg="white", pady = 20,command=bagi)
kal = Button(root,text="x",padx = 30,bg="#FF5733",fg="white", pady = 20,command=kali)
pang = Button(root,text="x2",padx = 30,bg="#FF5733",fg="white", pady = 20,command=pangkat)
ak2 = Button(root,text="sq2",padx = 30,bg="#FF5733",fg="white", pady = 20,command=akar)
sisbag = Button(root,text="%",padx = 30,bg="#FF5733",fg="white", pady = 20,command=sisabagi)
hap = Button(root,text="C",padx = 30,bg="#FF5733",fg="white", pady = 20,command=hapus)
equal = Button(root,text="=",padx = 100,bg="skyblue", pady = 20,command=samadengan)
dec = Button(root,text=".",padx = 30,bg="#FF5733",fg="white", pady = 20,command=desimal)
